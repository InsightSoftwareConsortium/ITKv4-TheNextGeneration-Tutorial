 ...
 *
 *=========================================================================*/
#ifndef __itkRegistrationParameterScaleEstimator_h
#define __itkRegistrationParameterScaleEstimator_h
...
/** \class RegistrationParameterScaleEstimator
...
class ITK_EXPORT RegistrationParameterScaleEstimator : public OptimizerParameterScaleEstimator
{
public:
  /** Standard class typedefs. */
  typedef RegistrationParameterScaleEstimator   Self;
  typedef OptimizerParameterScaleEstimator      Superclass;
  typedef SmartPointer<Self>                    Pointer;
  typedef SmartPointer<const Self>              ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro( RegistrationParameterScaleEstimator, OptimizerParameterScaleEstimator );
  ...
  /** The stratigies to sample physical points in the virtual domain. */
  typedef enum { SamplingWithFullDomain, SamplingWithCorners, SamplingWithRandom}
...
private:
  RegistrationParameterScaleEstimator(const Self&); //purposely not implemented
...
#include "itkRegistrationParameterScaleEstimator.hxx"
#endif

#endif /* __itkRegistrationParameterScaleEstimator_h */
