 ...
 * from a unit variation of this parameter. The maximization is done by checking
 ...
 * SetSamplingStrategy(SamplingWithCorners).
 *
 * \ingroup ITKHighDimensionalOptimizers
 */
template < class TMetric >
class ITK_EXPORT RegistrationParameterScalesFromShift :
  public RegistrationParameterScaleEstimator< TMetric >
{
public:
  /** Standard class typedefs. */
  typedef RegistrationParameterScalesFromShift            Self;
  typedef RegistrationParameterScaleEstimator< TMetric >  Superclass;
  ...
  itkTypeMacro( RegistrationParameterScalesFromShift, RegistrationParameterScaleEstimator );
