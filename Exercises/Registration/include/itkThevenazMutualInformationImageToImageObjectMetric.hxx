/*=========================================================================
  ...
  Module:    $RCSfile: itkThevenazMutualInformationImageToImageObjectMetric.h,v $
  Language:  C++
  Date:      $Date: $
  Version:   $Revision: $
...
#ifndef __itkThevenazMutualInformationImageToImageObjectMetric_hxx
#define __itkThevenazMutualInformationImageToImageObjectMetric_hxx
...
::ThevenazMutualInformationImageToImageObjectMetric()
{
  ...
  // Smooth the pdf on update
  this->m_DoSmoothJointPDF = true;
...
// Get the value
template <class TFixedImage, class TMovingImage, class TVirtualImage>
typename ThevenazMutualInformationImageToImageObjectMetric<TFixedImage,TMovingImage,TVirtualImage>::MeasureType
ThevenazMutualInformationImageToImageObjectMetric<TFixedImage,TMovingImage,TVirtualImage>
::GetValue()
{
  /**
...
template <class TFixedImage, class TMovingImage, class TVirtualImage>
typename ThevenazMutualInformationImageToImageObjectMetric<TFixedImage, TMovingImage, TVirtualImage>::InternalComputationValueType
ThevenazMutualInformationImageToImageObjectMetric<TFixedImage, TMovingImage, TVirtualImage>
