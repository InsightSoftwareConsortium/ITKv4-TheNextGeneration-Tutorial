 ...
 *
 *=========================================================================*/
#ifndef __itkGaussianSmoothingOnUpdateDisplacementFieldTransform2_h
#define __itkGaussianSmoothingOnUpdateDisplacementFieldTransform2_h
...
/** \class GaussianSmoothingOnUpdateDisplacementFieldTransform2
...
class ITK_EXPORT GaussianSmoothingOnUpdateDisplacementFieldTransform2 :
  public DisplacementFieldTransform<TScalar, NDimensions>
{
public:
  /** Standard class typedefs. */
  typedef GaussianSmoothingOnUpdateDisplacementFieldTransform2   Self;
  typedef DisplacementFieldTransform<TScalar, NDimensions>      Superclass;
  typedef SmartPointer<Self>                                    Pointer;
  typedef SmartPointer<const Self>                              ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro( GaussianSmoothingOnUpdateDisplacementFieldTransform2,
   ...
   */
  virtual DisplacementFieldPointer GaussianSmoothDisplacementFieldNick( DisplacementFieldType *, ScalarType );
...
protected:
  ...
  virtual ~GaussianSmoothingOnUpdateDisplacementFieldTransform2();
...
private:
  GaussianSmoothingOnUpdateDisplacementFieldTransform2( const Self& ); //purposely not implemented
...
# include "Templates/itkGaussianSmoothingOnUpdateDisplacementFieldTransform2+-.h"
#endif

#if ITK_TEMPLATE_TXX
# include "itkGaussianSmoothingOnUpdateDisplacementFieldTransform2.hxx"
#endif

#endif // __itkGaussianSmoothingOnUpdateDisplacementFieldTransform2_h
