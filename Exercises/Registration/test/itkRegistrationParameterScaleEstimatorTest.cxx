...
/**
 *  \class RegistrationParameterScaleEstimatorTest for test.
 *  Create a simple scales estimator class to use for testing here.
 */
template < class TMetric >
class ITK_EXPORT RegistrationParameterScaleEstimatorTest:
  public itk::RegistrationParameterScaleEstimator< TMetric >
{
public:
  /** Standard class typedefs. */
  typedef RegistrationParameterScaleEstimatorTest                     Self;
  typedef itk::RegistrationParameterScaleEstimator< TMetric >         Superclass;
  typedef itk::SmartPointer< Self >                                   Pointer;
  typedef itk::SmartPointer< const Self >                             ConstPointer;

  itkNewMacro(Self);

  itkTypeMacro(RegistrationParameterScaleEstimatorTest, RegistrationParameterScaleEstimator);
...
protected:
  RegistrationParameterScaleEstimatorTest(){};
  ~RegistrationParameterScaleEstimatorTest(){};

private:
  RegistrationParameterScaleEstimatorTest(const Self&); //purposely not implemented
...
/**
 */
int itkRegistrationParameterScaleEstimatorTest(int , char* [])
{
  ...
  typedef RegistrationParameterScaleEstimatorTest< MetricType >
    RegistrationParameterScaleEstimatorTestType;
  RegistrationParameterScaleEstimatorTestType::Pointer jacobianScaleEstimator
    = RegistrationParameterScaleEstimatorTestType::New();
  ...
  jacobianScaleEstimator->SetSamplingStrategy(
    RegistrationParameterScaleEstimatorTestType::SamplingWithCorners);
  jacobianScaleEstimator->Print( std::cout );

  RegistrationParameterScaleEstimatorTestType::ScalesType jacobianScales(
  ...
  RegistrationParameterScaleEstimatorTestType::ScalesType theoreticalJacobianScales(
    movingTransform->GetNumberOfParameters());
  ...
  jacobianScaleEstimator->SetSamplingStrategy(
    RegistrationParameterScaleEstimatorTestType::SamplingWithRandom);
  ...
  jacobianScaleEstimator->SetSamplingStrategy(
    RegistrationParameterScaleEstimatorTestType::SamplingWithFullDomain);
  jacobianScaleEstimator->EstimateScales(jacobianScales);
  ...
  // Testing RegistrationParameterScaleEstimatorTest done
  std::cout << std::endl;
